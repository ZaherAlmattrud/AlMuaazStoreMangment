<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="a_dashboard_icon align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}" style="display: flex;justify-content: center;">
    {{-- <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">  --}}
        <img src="../assets/img/logo-ct.png" class="image_dashboard_icon navbar-brand-img h-100" alt="..." style="position: relative;top: -28px;max-height: 105px"> --}}
