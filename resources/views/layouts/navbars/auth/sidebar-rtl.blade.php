<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret " id="sidenav-main" style="overflow:hidden;">
  <div class="sidenav-header" style="margin-bottom:40px;">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}"  style="display: flex;justify-content: center;">
        <img src="../assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="..." style="position: relative;top: -28px;max-height: 105px">
    </a>
  </div>

  {{-- <div class="collapse navbar-collapse px-0 w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main" style="direction:rtl"> --}}
  <div class="collapse navbar-collapse px-0 w-auto " id="sidenav-collapse-main" style="direction:rtl;height:84%">
    <ul class="navbar-nav">
      <li class="nav-item">
